...
class Server():
    ...
    def accept_connection(self):
        ...
        while True:
            ...
            client.send(bytes("Hello there! Tell me your name and press enter!", "utf8"))
            self.addr_dict[client] = client_address
    ...
    def handle_client(self):
        ...
        while True:
            ...
            if msg != bytes("#out#", "utf8"):
                ...
                self.SERVER.broadcast(bytes("{} has left the chat." .format(name), "utf8"))
                print("{} has left the conversation".format(name))
                break
